...
namespace UniversalUtilities
{
    ...
    public class Fitting
    {
        ...
        /// 获取多项式系数
        /// </summary>
        /// <param name="arrX">X值</param>
        /// <param name="arrY">Y值</param>
        /// <param name="length">各值数量</param>
        /// <param name="dimension">多项式阶数</param>
        /// <returns></returns>
        public static double[] GetCoefficient(double[] arrX, double[] arrY, int length, int dimension)
        {
            int n = dimension + 1;
